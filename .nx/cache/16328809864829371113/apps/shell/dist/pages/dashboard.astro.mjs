import { c as createComponent, r as renderComponent, b as renderTemplate } from '../chunks/astro/server_D_HKXSiX.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useStore } from '@nanostores/react';
import { a as authStore, l as logout } from '../chunks/users_DSSH0EFa.mjs';
import { $ as $$Layout } from '../chunks/Layout_xHsTS8nn.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DashboardInfo", DashboardInfo, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@app2-ui", "client:component-export": "DashboardInfo" })}` })}`;
